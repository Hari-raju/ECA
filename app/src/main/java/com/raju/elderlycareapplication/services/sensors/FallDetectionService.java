package com.raju.elderlycareapplication.services.sensors;
...
import com.raju.elderlycareapplication.services.FallDetectedActivity;
...
public class FallDetectionService extends Service implements SensorEventListener {
    ...
    private final Handler mPeriodicEventHandler = new Handler();
    ...
    public void onCreate() {
        Log.d("OnCreate", "Initialing Service");
        super.onCreate();
    }
    ...
    private Notification getNotification() {
        Log.d("Foreground", "service:creating Notification");
            ...
            if (SMV > 25) {
                if (sentRecently == 'N') {
                    ...
                    if (degreeFloat>10 && degreeFloat2>10 && degreeFloat > 70 || degreeFloat2 > 70) {
                        ...
                        handler.post(() -> Toast.makeText(FallDetectionService.this.getApplicationContext(), "Sensed Danger! Sending SMS", Toast.LENGTH_SHORT).show());
                        sendNotification("Fall Alert");
                    } else {
                        Log.d("Degree:", "Else 1 :" + degreeFloat);
                        Log.d("Degree:", "Else 2 :" + degreeFloat2);
                        handler.post(() -> Toast.makeText(FallDetectionService.this.getApplicationContext(), "Sudden Movement! But looks safe", Toast.LENGTH_SHORT).show());
                    }
                    sentRecently = 'Y';
    ...
    private void sendNotification(String message){
        ...
        Intent notificationIntent = new Intent(this, FallDetectedActivity.class);
        notificationIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TASK);
        PendingIntent pendingIntent = PendingIntent.getActivity(this, 6000, notificationIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    private void startCountDown(){
        ...
        countDownTimer = new CountDownTimer(30000,1000) {
            ...
            public void onFinish() {
                ...
                //Send Alert
                Log.d("Fall Detection Alert","Finished");
                NotificationHelper.sendNotification(FallDetectionService.this,"Fall was detected from elder phone and\nthey're not responding please check them!");
            }
        }.start();
    }
